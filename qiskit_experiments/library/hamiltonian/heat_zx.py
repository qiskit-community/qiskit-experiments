...
class ZXHeat(BatchHeatHelper):
    ...
    # section: overview
        ...
        .. parsed-literal::
            ...
            q_0: ────────────░─┤0      ├───────────────────────────░─────────
                 ┌─────────┐ ░ │  heat │┌────────────────┐┌──────┐ ░ ┌───┐┌─┐
            q_1: ┤ Ry(π/2) ├─░─┤1      ├┤ Rx(-1.0*angle) ├┤ A(π) ├─░─┤ B ├┤M├
                 └─────────┘ ░ └───────┘└────────────────┘└──────┘ ░ └───┘└╥┘
            c: 1/══════════════════════════════════════════════════════════╩═
                                                                           0
                             (xN)
            ...
            q_0: ───┤ X ├────░─┤0      ├──────────────────────░─────────
                 ┌──┴───┴──┐ ░ │  heat │┌───────────┐┌──────┐ ░ ┌───┐┌─┐
            q_1: ┤ Ry(π/2) ├─░─┤1      ├┤ Rx(angle) ├┤ A(π) ├─░─┤ B ├┤M├
                 └─────────┘ ░ └───────┘└───────────┘└──────┘ ░ └───┘└╥┘
            c: 1/═════════════════════════════════════════════════════╩═
                                                                      0

        ZX-HEAT experiments are performed with combination of two
        error amplification experiments shown above, where (``A``, ``B``)
        are gates designed based on the interrogated error axis.
        Namely, (``Rx(pi)``, ``I``), (``Ry(pi)``, ``I``), (``Rz(pi)``, ``Rx(pi/2)``)

...
class DragCalAnalysis(curve.CurveAnalysis):
    ...
    __series__ = [
        curve.SeriesDef(
            ...
            plot_symbol="o",
            model_description=r"{\rm amp} \cos(2 \pi f_0 (x - beta)) + {\rm base}",
        ),
        curve.SeriesDef(
            fit_func=lambda x, amp, freq0, freq1, freq2, beta, base: cos(
            ...
            plot_symbol="^",
            model_description=r"{\rm amp} \cos(2 \pi f_1 (x - beta)) + {\rm base}",
        ),
        curve.SeriesDef(
            fit_func=lambda x, amp, freq0, freq1, freq2, beta, base: cos(
            ...
            plot_symbol="v",
            model_description=r"{\rm amp} \cos(2 \pi f_2 (x - beta)) + {\rm base}",
        ),
    ]

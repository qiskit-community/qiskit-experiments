...
from qiskit_experiments.framework import BaseAnalysis, AnalysisResult
...
class QuantumVolumeAnalysis(BaseAnalysis):
    ...
    def _run_analysis(
        ...
        Returns:
            tuple: A pair ``(result_data figures)`` where
                   ...
                   :class:`AnalysisResult` objects, and ``figures`` may be
        ...
        analysis_result = self._calc_quantum_volume(heavy_output_prob_exp, depth, num_trials)
    ...
    def _calc_quantum_volume(self, heavy_output_prob_exp, depth, trials):
        ...
        return AnalysisResult(
            ...
            extra={
                ...
                "heavy_output_probability": heavy_output_prob_exp,
                "mean_hop": mean_hop,
                "sigma": sigma_hop,
                "depth": depth,
                "trials": trials,
    ...
    def _format_plot(ax, analysis_result):
        ...
        """
        trials = analysis_result.extra["trials"]
        heavy_probs = analysis_result.extra["heavy_output_probability"]
        ...
        ax.set_title(
            ...
            + str(analysis_result.extra["depth"])
            + " - accumulative hop",
            fontsize=14,
        )

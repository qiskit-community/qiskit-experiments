    ...
    def from_values(
        ...
        **kwargs,
        ...
        Args:
            ...
            hub: The hub of the experiment
            group: The group of the experiment
            project: The project of the experiment
            verbose: Whether to explicitly print messages generated by the class
            **kwargs: Additional experiment attributes.
        Returns:
            The generated experiment data
        """

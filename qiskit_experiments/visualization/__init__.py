...
To collate style parameters together, plotters and drawers store instances of the :class:`PlotStyle`
class. These instances can be merged and updated, so that default styles can have their values
overwritten.

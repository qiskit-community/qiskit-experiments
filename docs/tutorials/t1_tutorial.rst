A :math:`T_1` experiment - Tutorial
===================================
...
---------------------------------------------------
:math:`T_1` experiments can also be performed with kerneled measurements.
...
since we know that :math:`P(1|t=0)=1`, we add a circuit with delay=0,

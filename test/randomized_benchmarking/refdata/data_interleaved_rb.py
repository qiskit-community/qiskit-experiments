...
"""
Interleaved RB data generation.
"""
import argparse
import json
import os
...
def _interleaved_rb_exp_data_gen(dir_name: str, num_samples: int, seed_val: int):
    """
...
if __name__ == "__main__":
    ...
    _interleaved_rb_exp_data_gen(args.folder, args.samples, args.seed)

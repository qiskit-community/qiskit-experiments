...
"""
Low confidence data generation.
"""
import argparse
import json
import os
...
try:
    from .utils import create_noise_model
except ImportError:
    # we cannot use relative import from the top level module.
    from utils import create_noise_model


def _create_qv_data_low_confidence(dir_path: str, seed_val: int):
    """
...
if __name__ == "__main__":
    ...
    _create_qv_data_low_confidence(args.folder, args.seed)

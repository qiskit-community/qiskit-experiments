...
class TestFineAmpEndToEnd(QiskitTestCase):
    ...
    def test_end_to_end_under_rotation(self):
        ...
        amp_exp.set_analysis_options(number_guesses=11, angle_per_gate=np.pi)
        amp_exp.set_transpile_options(basis_gates=["xp", "x"])
    ...
    def test_end_to_end_over_rotation(self):
        ...
        amp_exp = FineAmplitude(0, Gate("xp", 1, []))
        amp_exp.set_analysis_options(number_guesses=6, angle_per_gate=np.pi)
        amp_exp.set_transpile_options(basis_gates=["xp", "x"])
        ...
        print(d_theta, backend.angle_error)
...
class TestFineAmplitudeCal(QiskitTestCase):
    ...
    def setUp(self):
        ...
        # TODO setup an instance of cals.

    def test_transpile_cals(self):
        """Test that we can transpile in the calibrations before and after update."""
        self.fail("TODO")

    def test_options(self):
        """Test that the options are properly set for the subclasses."""
        self.fail("TODO")

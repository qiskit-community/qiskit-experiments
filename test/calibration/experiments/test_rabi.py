...
class TestRabiEndToEnd(QiskitTestCase):
    ...
    def test_rabi_end_to_end(self):
        ...
        self.assertTrue(abs(result.value[1] - backend.rabi_rate) < test_tol)
    ...
    def test_wrong_processor(self):
        ...
        self.assertTrue(f"The input key {fail_key} was not found" in result.value.message)
...
class TestRabiAnalysis(QiskitTestCase):
    ...
    def test_good_analysis(self):
        ...
        self.assertTrue(abs(result[0].value[1] - expected_rate) < test_tol)

...
class TestCalibrationsBasic(QiskitTestCase):
    ...
    def setUp(self):
        ...
        for sched in [xp, x90p, y90p, xm]:
            self.cals.add_schedule(sched, n_qubits=1)
    ...
    def test_channel_names(self):
        ...
        self.cals.add_schedule(sched_good, n_qubits=2)

        with self.assertRaises(CalibrationError):
            self.cals.add_schedule(sched_bad, n_qubits=2)
...
class TestConcurrentParameters(QiskitTestCase):
    ...
    def test_concurrent_values(self):
        ...
        cals.add_schedule(xp, n_qubits=1)
...
class TestMeasurements(QiskitTestCase):
    ...
    def setUp(self):
        ...
        self.cals = Calibrations()
        self.cals.add_schedule(meas, n_qubits=1)
        self.cals.add_schedule(xp, n_qubits=1)
        self.cals.add_schedule(xp_meas, n_qubits=1)
        self.cals.add_schedule(xt_meas, n_qubits=2)
        self.cals.add_schedule(meas_acq, n_qubits=1)
...
class TestInstructions(QiskitTestCase):
    ...
    def setUp(self):
        ...
        self.cals = Calibrations()
        self.cals.add_schedule(xp, n_qubits=1)
        self.cals.add_schedule(xp12, n_qubits=1)
        self.cals.add_schedule(xp02, n_qubits=1)
...
class TestRegistering(QiskitTestCase):
    ...
    def test_call_registering(self):
        ...
        with self.assertRaises(CalibrationError):
            self.cals.add_schedule(call_xp, n_qubits=1)
    ...
    def test_get_template(self):
        ...
        self.cals.add_schedule(dxp, n_qubits=1)
...
class CrossResonanceTest(QiskitTestCase):
    ...
    def setUp(self):
        ...
        self.cals.add_schedule(xp, n_qubits=1)
        self.cals.add_schedule(cr, n_qubits=2)
        self.cals.add_schedule(tcp, n_qubits=2)
...
class TestAssignment(QiskitTestCase):
    ...
    def setUp(self):
        ...
        self.xp_ = xp
        self.cals.add_schedule(xp, n_qubits=1)
        self.cals.add_schedule(xpxp, n_qubits=2)
    ...
    def test_assign_to_parameter_in_call_and_to_value_in_caller(self):
        ...
        with pulse.build(name="call_xp_xp") as call_xp_xp:
            pulse.call(self.xp_)
            pulse.play(Gaussian(160, self.amp_xp, self.sigma), self.d0_)
        self.cals.add_schedule(call_xp_xp, n_qubits=1)
...
class TestReplaceScheduleAndCall(QiskitTestCase):
    ...
    def test_call_replaced(self):
        ...
        self.cals.add_schedule(drag, n_qubits=1)
...
class TestCoupledAssigning(QiskitTestCase):
    ...
    def setUp(self):
        ...
        self.cals.add_schedule(cr_p, n_qubits=2)
        self.cals.add_schedule(cr_m, n_qubits=2)
        self.cals.add_schedule(xp, n_qubits=1)
        self.cals.add_schedule(ecr, n_qubits=2)
        self.cals.add_schedule(cr_echo_both, n_qubits=2)
